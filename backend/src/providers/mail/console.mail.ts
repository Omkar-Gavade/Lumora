 ...
 * and is readable in a terminal; dumping a table-based email layout into a log
 * makes the one thing anyone wants — the URL — the hardest thing to find.
 *
...
export class ConsoleMailProvider implements MailProvider {
  ...
  /**
   * Always healthy. There is no transport to check — and reporting anything
   * else would make the startup log claim a problem that does not exist.
   */
